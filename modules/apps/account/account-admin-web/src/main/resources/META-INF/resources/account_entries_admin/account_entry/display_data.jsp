...
<div class="sheet-section">
	...
	<aui:row>
		...
		>
			<aui:field-wrapper
				cssClass="form-group lfr-input-text-container"
			>
				<aui:input
					label="account-name"
					name="name"
					required="<%= true %>"
					type="text"
					value="<%= (accountEntryDisplay == null) ? StringPool.BLANK : accountEntryDisplay.getName() %>"
				>
	...
	>
		<aui:input
			name="description"
			type="textarea"
			value="<%= (accountEntryDisplay == null) ? StringPool.BLANK : accountEntryDisplay.getDescription() %>"
		/>
	</aui:field-wrapper>
	...
	>
		<aui:input
			...
			name="active"
			type="toggle-switch"
			value="<%= (accountEntryDisplay == null) ? true : accountEntryDisplay.isActive() %>"
		/>
	</aui:field-wrapper>
</div>