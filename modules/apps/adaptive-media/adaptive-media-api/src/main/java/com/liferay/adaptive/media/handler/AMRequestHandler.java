...
public interface AMRequestHandler<T> {
	 ...
	 * Optional} instance. If no media is found matching the httpServletRequest, or an
	 * application error is raised while fetching the media, an empty {@link
	 * Optional} is returned.
	 *
	 * @param  httpServletRequest the httpServletRequest to process
	 * @return a non-<code>null</code> {@link Optional} instance containing the
	 *         value (if any).
	 * @throws IOException if an IO error occurred while processing the httpServletRequest
