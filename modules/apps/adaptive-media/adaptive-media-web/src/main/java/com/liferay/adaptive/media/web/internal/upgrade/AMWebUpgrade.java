...
import com.liferay.adaptive.media.web.internal.upgrade.v1_0_0.JournalArticleDataFileEntryIdUpgradeProcess;
...
public class AMWebUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"1.0.1", "1.0.2",
			new BlogsEntryDataFileEntryIdUpgradeProcess(_blogsEntryLocalService),
