...
/**
 * The table class for the Status.
 *
...
public class StatusTable extends BaseTable<StatusTable> {
	...
	public final Column<StatusTable, Boolean> playSound = createColumn(
		"playSound", Boolean.class, Types.BOOLEAN);
