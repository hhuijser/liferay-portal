...
package com.liferay.web.form.web.internal.upgrade;
...
public class WebFormWebUpgrade implements UpgradeStepRegistrar {
		...
		BaseUpgradeWebModuleRelease upgradeWebModuleRelease =
			new BaseUpgradeWebModuleRelease() {
				...
				protected String getBundleSymbolicName() {
					return "com.liferay.web.form.web";
				}

				@Override
				protected String[] getPortletIds() {
					return new String[] {"1_WAR_webformportlet"};
				}
