...
import com.liferay.asset.display.page.internal.upgrade.v3_0_0.AssetDisplayPageEntryUpgradeProcess;
...
public class AssetDisplayPageServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register("2.3.2", "3.0.0", new AssetDisplayPageEntryUpgradeProcess());
