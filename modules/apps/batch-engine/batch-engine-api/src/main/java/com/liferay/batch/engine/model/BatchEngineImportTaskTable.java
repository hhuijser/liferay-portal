...
/**
 * The table class for the BatchEngineImportTask.
 *
 * @author Shuyang Zhou
 * @generated
 */
public class BatchEngineImportTaskTable
	...
	public final Column<BatchEngineImportTaskTable, Long> batchSize =
		createColumn("batchSize", Long.class, Types.BIGINT);
	...
	public final Column<BatchEngineImportTaskTable, Clob> fieldNameMapping =
		createColumn("fieldNameMapping", Clob.class, Types.CLOB);
	public final Column<BatchEngineImportTaskTable, String> operation =
		createColumn("operation", String.class, Types.VARCHAR);
	...
	public final Column<BatchEngineImportTaskTable, String> version =
