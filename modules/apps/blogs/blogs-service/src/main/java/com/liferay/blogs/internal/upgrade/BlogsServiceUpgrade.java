...
public class BlogsServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"1.0.0", "1.1.0",
			new com.liferay.blogs.internal.upgrade.v1_1_0.BlogsEntryUpgradeProcess(
				_friendlyURLEntryLocalService));

		registry.register(
			"1.1.0", "1.1.1",
			new com.liferay.blogs.internal.upgrade.v1_1_1.BlogsEntryUpgradeProcess());

		registry.register(
			"1.1.1", "1.1.2",
			new BlogsImagesUpgradeProcess(_imageLocalService, _portletFileRepository));
		...
		registry.register(
			"2.1.0", "2.1.1",
			new com.liferay.blogs.internal.upgrade.v2_1_1.BlogsEntryUpgradeProcess());
	}
