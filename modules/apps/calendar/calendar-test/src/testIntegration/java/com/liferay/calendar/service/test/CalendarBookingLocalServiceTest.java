...
public class CalendarBookingLocalServiceTest {
	...
	public void testUpdateCalendarBookingPreservesDescriptionTranslations()
		...
		Map<Locale, String> oldDescriptionMap = HashMapBuilder.types(
		...
		Map<Locale, String> newDescriptionMap = HashMapBuilder.types(
			Locale.class, String.class
		).put(
			LocaleUtil.GERMANY, ""
		).put(
	...
	public void testUpdateCalendarBookingPreservesTitleTranslations()
		...
		Map<Locale, String> oldTitleMap = HashMapBuilder.types(
			Locale.class, String.class
		).put(
			LocaleUtil.BRAZIL, RandomTestUtil.randomString()
		).put(
		...
		Map<Locale, String> newTitleMap = HashMapBuilder.types(
			Locale.class, String.class
		).put(
			LocaleUtil.GERMANY, ""
		).put(
	...
	public void testUpdateStagedSiteCalendarBookingShouldUpdateInviteSiteCalendarBooking()
		...
		Map<Locale, String> titleMap = HashMapBuilder.types(
			Locale.class, String.class
		).put(
			LocaleUtil.US, RandomTestUtil.randomString()
		).build();
