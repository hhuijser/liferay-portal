...
public class CommerceOrderRuleEntryLocalServiceImpl
	...
	@Override
	public List<CommerceOrderRuleEntry> getCommerceRuleEntriesByAccount(
	...
	@Override
	public List<CommerceOrderRuleEntry> getCommerceRuleEntriesByAccountGroups(
	...
	@Override
	public List<CommerceOrderRuleEntry> getCommerceRuleEntriesByChannel(
	...
	@Override
	public List<CommerceOrderRuleEntry> getCommerceRuleEntriesByOrderType(
	...
	private GroupByStep _getGroupByStep(
		...
		JoinStep joinStep = fromStep.from(
			...
			aliasCommerceOrderRuleEntryAccountEntryRel,
			CommerceOrderRuleEntryRelTable.INSTANCE.classNameId.eq(
		...
		if (accountEntryId != null) {
			predicate = predicate.and(
				aliasCommerceOrderRuleEntryAccountEntryRel.classPK.eq(
					accountEntryId));
		}
		else {
			predicate = predicate.and(
		...
		if (accountGroupIds != null) {
			...
			predicate = predicate.and(
				aliasCommerceOrderRuleEntryAccountGroupRel.classPK.in(
					longStream.boxed(
					).toArray(
						Long[]::new
					)));
		...
		if (commerceChannelId != null) {
			predicate = predicate.and(
				aliasCommerceOrderRuleEntryCommerceChannelRel.classPK.eq(
					commerceChannelId));
		}
		else {
			predicate = predicate.and(
		...
		if (commerceOrderTypeId != null) {
			predicate = predicate.and(
				aliasCommerceOrderRuleEntryCommerceOrderTypeRel.classPK.eq(
					commerceOrderTypeId));
		}
		else {
			predicate = predicate.and(
