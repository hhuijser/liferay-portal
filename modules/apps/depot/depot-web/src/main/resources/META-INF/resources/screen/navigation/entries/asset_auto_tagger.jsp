...
<c:if test="<%= assetAutoTaggerConfiguration.isAvailable() %>">
	...
	>
		<aui:input
			helpMessage="asset-library-asset-auto-tagging-help"
			label="enable-auto-tagging-of-assets-on-this-asset-library"
			name="TypeSettingsProperties--assetAutoTaggingEnabled--"
			type="toggle-switch"
			value="<%= assetAutoTaggerConfiguration.isEnabled() %>"
		/>
	</liferay-frontend:fieldset>
</c:if>