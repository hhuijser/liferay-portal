...
public class FieldSetDDMFormFieldTemplateContextContributorTest {
	...
	public void testGetParametersWithHorizontalFieldSet() {
		...
		Map<String, Object> nestedField0 = HashMapBuilder.put(
			"name", "field0"
		).put(
			"type", "text"
		).build();

		Map<String, Object> nestedField1 = HashMapBuilder.put(
			"name", "field1"
		).put(
			"type", "checkbox"
		).build();

		Map<String, List<Object>> nestedFields = HashMapBuilder.put(
			"field0", Arrays.<Object>asList(nestedField0)
		).put(
			"field1", Arrays.<Object>asList(nestedField1)
		).build();

		Map<String, Object> properties = HashMapBuilder.put(
	...
	public void testGetParametersWithVerticalFieldSet() {
		...
		Map<String, Object> nestedField2 = HashMapBuilder.put(
			"name", "field2"
		).put(
			"type", "select"
		).build();
