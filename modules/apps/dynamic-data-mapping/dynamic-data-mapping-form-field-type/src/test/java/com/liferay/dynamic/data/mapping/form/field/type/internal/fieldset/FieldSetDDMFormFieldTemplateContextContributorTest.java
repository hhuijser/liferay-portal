...
public class FieldSetDDMFormFieldTemplateContextContributorTest {
	...
	public void testGetParametersWithHorizontalFieldSet() {
		...
		Map<String, Object> nestedField0 = HashMapBuilder.types(
		...
		Map<String, Object> nestedField1 = HashMapBuilder.types(
			String.class, Object.class
		).put(
			"name", "field1"
		).put(
		...
		Map<String, List<Object>> nestedFields = HashMapBuilder.types(
		...
		Map<String, Object> properties = HashMapBuilder.types(
			String.class, Object.class
		).put(
	...
	public void testGetParametersWithVerticalFieldSet() {
		...
		Map<String, Object> nestedField2 = HashMapBuilder.types(
			String.class, Object.class
		).put(
			"name", "field2"
		).put(
