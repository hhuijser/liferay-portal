...
public class DDMFormFieldTemplateContextFactoryTest {
	...
	public void testNotReadOnlyTextFieldAndReadOnlyForm() {
		...
		Map<String, Object> changedProperties = HashMapBuilder.types(
		...
		Map<DDMFormEvaluatorFieldContextKey, Map<String, Object>>
			ddmFormFieldsPropertyChanges = HashMapBuilder.types(
				DDMFormEvaluatorFieldContextKey.class, Map.class
			).put(
