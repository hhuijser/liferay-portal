...
import com.liferay.dynamic.data.mapping.internal.upgrade.v4_0_0.DDMFieldUpgradeProcess;
...
public class DDMServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"1.0.0", "1.0.1", new ResourcePermissionUpgradeProcess(_resourceActions));
		...
		registry.register(
			...
			new com.liferay.dynamic.data.mapping.internal.upgrade.v1_1_0.
				DDMStructureUpgradeProcess(ddmFormJSONDeserializer, ddmFormSerializer),
			new com.liferay.dynamic.data.mapping.internal.upgrade.v1_1_0.
		...
		registry.register(
			"2.0.3", "2.0.4", new DDMFormParagraphFieldsUpgradeProcess(_jsonFactory));

		registry.register(
			"2.0.4", "2.0.5", new DDMFormFieldValidationUpgradeProcess(_jsonFactory));

		registry.register(
			"2.0.5", "2.0.6", new DDMDataProviderInstanceUpgradeProcess(_jsonFactory));
		...
		registry.register("3.0.0", "3.1.0", new DDMStructureLayoutUpgradeProcess());
		...
		registry.register("3.4.0", "3.5.0", new DDMFormInstanceReportUpgradeProcess());
		...
		registry.register(
			...
			new com.liferay.dynamic.data.mapping.internal.upgrade.v3_8_0.
				DDMContentUpgradeProcess(ddmFormJSONDeserializer, _jsonFactory));
		...
		registry.register(
			"4.2.0", "4.3.0", new DLFileEntryTypeDDMFieldAttributeUpgradeProcess(),
