...
public class DDMDataProviderInstancesServletTest {
	...
	public void testThemeDisplayIsPresent()
		...
		_ddmDataProviderInstancesServlet.service(
	...
	@Inject(
		filter = "osgi.http.whiteboard.servlet.name=com.liferay.dynamic.data.mapping.form.builder.internal.servlet.DDMDataProviderInstancesServlet"
	)
