...
public class DDMFieldSetDefinitionServletTest {
	...
	public void testThemeDisplayIsPresent()
		...
		mockHttpServletRequest.setAttribute(
			...
			"http://liferay.com/web/guest/dynamic-data-mapping-form-builder-" +
				"field-settings-form-context");

		_ddmFieldSetDefinitionServlet.service(
	...
	@Inject(
		filter = "osgi.http.whiteboard.servlet.name=com.liferay.dynamic.data.mapping.form.builder.internal.servlet.DDMFieldSetDefinitionServlet"
	)
