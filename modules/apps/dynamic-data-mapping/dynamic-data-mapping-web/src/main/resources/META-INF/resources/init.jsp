...
page import="com.liferay.dynamic.data.mapping.model.constants.DDMStructureConstants" %><%@
page import="com.liferay.dynamic.data.mapping.model.constants.DDMTemplateConstants" %><%@
