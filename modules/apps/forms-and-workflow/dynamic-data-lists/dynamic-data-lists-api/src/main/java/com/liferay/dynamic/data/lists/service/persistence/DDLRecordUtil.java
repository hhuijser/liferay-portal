...
public class DDLRecordUtil {
	...
	* @return the matching d d l records
	*/
	public static List<DDLRecord> findByU_R(long userId, long recordSetId) {
		return getPersistence().findByU_R(userId, recordSetId);
	}
	...
	*/
	public static List<DDLRecord> findByU_R(long userId, long recordSetId,
		int start, int end) {
		return getPersistence().findByU_R(userId, recordSetId, start, end);
	}
	...
	*/
	public static List<DDLRecord> findByU_R(long userId, long recordSetId,
		int start, int end, OrderByComparator<DDLRecord> orderByComparator) {
		return getPersistence()
				   .findByU_R(userId, recordSetId, start, end, orderByComparator);
	}
	...
	*/
	public static List<DDLRecord> findByU_R(long userId, long recordSetId,
		...
		boolean retrieveFromCache) {
		return getPersistence()
				   .findByU_R(userId, recordSetId, start, end,
			orderByComparator, retrieveFromCache);
	}
	...
	* @throws NoSuchRecordException if a matching d d l record could not be found
	*/
	public static DDLRecord findByU_R_First(long userId, long recordSetId,
		OrderByComparator<DDLRecord> orderByComparator)
		throws com.liferay.dynamic.data.lists.exception.NoSuchRecordException {
		return getPersistence()
				   .findByU_R_First(userId, recordSetId, orderByComparator);
	}
	...
	* @return the first matching d d l record, or <code>null</code> if a matching d d l record could not be found
	*/
	public static DDLRecord fetchByU_R_First(long userId, long recordSetId,
		OrderByComparator<DDLRecord> orderByComparator) {
		return getPersistence()
				   .fetchByU_R_First(userId, recordSetId, orderByComparator);
	}
	...
	* @throws NoSuchRecordException if a matching d d l record could not be found
	*/
	public static DDLRecord findByU_R_Last(long userId, long recordSetId,
		OrderByComparator<DDLRecord> orderByComparator)
		throws com.liferay.dynamic.data.lists.exception.NoSuchRecordException {
		return getPersistence()
				   .findByU_R_Last(userId, recordSetId, orderByComparator);
	}
	...
	* @return the last matching d d l record, or <code>null</code> if a matching d d l record could not be found
	*/
	public static DDLRecord fetchByU_R_Last(long userId, long recordSetId,
		OrderByComparator<DDLRecord> orderByComparator) {
		return getPersistence()
				   .fetchByU_R_Last(userId, recordSetId, orderByComparator);
	}
	...
	* @throws NoSuchRecordException if a d d l record with the primary key could not be found
	*/
	public static DDLRecord[] findByU_R_PrevAndNext(long recordId, long userId,
		long recordSetId, OrderByComparator<DDLRecord> orderByComparator)
		throws com.liferay.dynamic.data.lists.exception.NoSuchRecordException {
		return getPersistence()
				   .findByU_R_PrevAndNext(recordId, userId, recordSetId,
			orderByComparator);
	}
	...
	* @param recordSetId the record set ID
	*/
	public static void removeByU_R(long userId, long recordSetId) {
		getPersistence().removeByU_R(userId, recordSetId);
	}
	...
	* @return the number of matching d d l records
	*/
	public static int countByU_R(long userId, long recordSetId) {
		return getPersistence().countByU_R(userId, recordSetId);
	}
