...
public class PollsVoteUtil {
	...
	* @return the matching polls votes
	*/
	public static List<PollsVote> findByU_Q(long userId, long questionId) {
		return getPersistence().findByU_Q(userId, questionId);
	}
	...
	*/
	public static List<PollsVote> findByU_Q(long userId, long questionId,
		int start, int end) {
		return getPersistence().findByU_Q(userId, questionId, start, end);
	}
	...
	*/
	public static List<PollsVote> findByU_Q(long userId, long questionId,
		...
		return getPersistence()
				   .findByU_Q(userId, questionId, start, end, orderByComparator);
	}
	...
	*/
	public static List<PollsVote> findByU_Q(long userId, long questionId,
		...
		boolean retrieveFromCache) {
		return getPersistence()
				   .findByU_Q(userId, questionId, start, end,
			orderByComparator, retrieveFromCache);
	}
	...
	* @throws NoSuchVoteException if a matching polls vote could not be found
	*/
	public static PollsVote findByU_Q_First(long userId, long questionId,
		OrderByComparator<PollsVote> orderByComparator)
		throws com.liferay.polls.exception.NoSuchVoteException {
		return getPersistence()
				   .findByU_Q_First(userId, questionId, orderByComparator);
	}
	...
	* @return the first matching polls vote, or <code>null</code> if a matching polls vote could not be found
	*/
	public static PollsVote fetchByU_Q_First(long userId, long questionId,
		OrderByComparator<PollsVote> orderByComparator) {
		return getPersistence()
				   .fetchByU_Q_First(userId, questionId, orderByComparator);
	}
	...
	* @throws NoSuchVoteException if a matching polls vote could not be found
	*/
	public static PollsVote findByU_Q_Last(long userId, long questionId,
		OrderByComparator<PollsVote> orderByComparator)
		throws com.liferay.polls.exception.NoSuchVoteException {
		return getPersistence()
				   .findByU_Q_Last(userId, questionId, orderByComparator);
	}
	...
	* @return the last matching polls vote, or <code>null</code> if a matching polls vote could not be found
	*/
	public static PollsVote fetchByU_Q_Last(long userId, long questionId,
		OrderByComparator<PollsVote> orderByComparator) {
		return getPersistence()
				   .fetchByU_Q_Last(userId, questionId, orderByComparator);
	}
	...
	* @throws NoSuchVoteException if a polls vote with the primary key could not be found
	*/
	public static PollsVote[] findByU_Q_PrevAndNext(long voteId, long userId,
		long questionId, OrderByComparator<PollsVote> orderByComparator)
		throws com.liferay.polls.exception.NoSuchVoteException {
		return getPersistence()
				   .findByU_Q_PrevAndNext(voteId, userId, questionId,
			orderByComparator);
	}
	...
	* @param questionId the question ID
	*/
	public static void removeByU_Q(long userId, long questionId) {
		getPersistence().removeByU_Q(userId, questionId);
	}
	...
	* @return the number of matching polls votes
	*/
	public static int countByU_Q(long userId, long questionId) {
		return getPersistence().countByU_Q(userId, questionId);
	}
