...
create index IX_56FC929A on FriendlyURL (groupId, companyId, classNameId, classPK, urlTitle[$COLUMN_LENGTH:75$]);
create index IX_53418A03 on FriendlyURL (groupId, companyId, classNameId, urlTitle[$COLUMN_LENGTH:75$]);
