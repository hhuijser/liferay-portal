...
public class LegacyLDAPPropsKeys {
	...
	public static final String[] LDAP_KEYS_NONPOSTFIXED = {
		LDAP_AUTH_ENABLED, LDAP_AUTH_REQUIRED, LDAP_IMPORT_ENABLED,
		LDAP_IMPORT_ON_STARTUP, LDAP_EXPORT_ENABLED,
		LegacyLDAPPropsKeys.LDAP_PASSWORD_POLICY_ENABLED,
		LDAP_IMPORT_USER_PASSWORD_AUTOGENERATED
	};

	public static final String[] LDAP_KEYS_POSTFIXED = {
		...
		LegacyLDAPPropsKeys.LDAP_SECURITY_CREDENTIALS,
		LegacyLDAPPropsKeys.LDAP_SECURITY_PRINCIPAL,
		LegacyLDAPPropsKeys.LDAP_SERVER_NAME,
		LegacyLDAPPropsKeys.LDAP_USER_CUSTOM_MAPPINGS,
		LegacyLDAPPropsKeys.LDAP_USER_DEFAULT_OBJECT_CLASSES,
		LegacyLDAPPropsKeys.LDAP_USER_MAPPINGS,
		LegacyLDAPPropsKeys.LDAP_USERS_DN
	};
	...
	/**
	* @deprecated As of com.liferay.portal.security.ldap#2.1.17, replaced by {@link LDAP_KEYS_NONPOSTFIXED}
	*/
	@Deprecated
	...
	/**
	* @deprecated As of com.liferay.portal.security.ldap#2.1.17, replaced by {@link LDAP_KEYS_POSTFIXED}
	*/
	@Deprecated
	public static final String[] POSTFIXED_LDAP_KEYS = LDAP_KEYS_POSTFIXED;
