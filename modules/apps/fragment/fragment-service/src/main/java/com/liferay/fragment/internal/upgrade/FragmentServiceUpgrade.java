...
import com.liferay.fragment.internal.upgrade.v2_2_1.FragmentEntryUpgradeProcess;
...
public class FragmentServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"2.1.1", "2.1.2",
			new com.liferay.fragment.internal.upgrade.v2_1_2.SchemaUpgradeProcess());

		registry.register(
			"2.1.2", "2.1.3",
			new com.liferay.fragment.internal.upgrade.v2_1_3.SchemaUpgradeProcess());
		...
		registry.register(
			"2.2.0", "2.2.1", new FragmentEntryUpgradeProcess(),
			new com.liferay.fragment.internal.upgrade.v2_2_1.SchemaUpgradeProcess());

		registry.register(
			"2.2.1", "2.3.0",
			new com.liferay.fragment.internal.upgrade.v2_3_0.
				FragmentEntryUpgradeProcess(),
			new com.liferay.fragment.internal.upgrade.v2_3_0.SchemaUpgradeProcess());

		registry.register("2.3.0", "2.4.0", new FragmentEntryLinkUpgradeProcess());
