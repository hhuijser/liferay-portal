...
import com.liferay.journal.internal.upgrade.v3_2_1.JournalArticleLocalizationUpgradeProcess;
...
public class JournalServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register("0.0.5", "0.0.6", new JournalArticleImageUpgradeProcess());
		...
		registry.register("1.0.0", "1.0.1", new JournalContentSearchUpgradeProcess());
		...
		registry.register(
			...
			new JournalArticleLocalizedValuesUpgradeProcess(_counterLocalService));
		...
		registry.register(
			"1.1.2", "1.1.3", new ResourcePermissionsUpgradeProcess(_resourceActions));
		...
		registry.register(
			"3.2.0", "3.2.1", new JournalArticleLocalizationUpgradeProcess());

		registry.register(
			"3.2.1", "3.2.2",
			new com.liferay.journal.internal.upgrade.v3_2_2.
				JournalArticleLocalizationUpgradeProcess());
		...
		registry.register(
			"3.3.0", "3.4.0", new StorageLinksUpgradeProcess(_classNameLocalService));
