...
public class MarketplaceServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		registry.register(
			"0.0.1", "1.0.0",
			new com.liferay.marketplace.internal.upgrade.v0_0_1.ExpandoUpgradeProcess(
				_expandoColumnLocalService, _expandoTableLocalService,
				_expandoValueLocalService));

		registry.register(
			"1.0.0", "1.0.1",
			new com.liferay.marketplace.internal.upgrade.v1_0_0.AppUpgradeProcess(),
		...
		registry.register(
			"1.0.2", "2.0.0",
			new com.liferay.marketplace.internal.upgrade.v2_0_0.AppUpgradeProcess());
		...
		registry.register(
			"2.0.1", "2.0.2",
			new com.liferay.marketplace.internal.upgrade.v2_0_2.AppUpgradeProcess());
	}
