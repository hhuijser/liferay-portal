...
public class IndexedFieldsFixture {
	...
	public void populateDate(
		String field, Date value, Map<String, Object> map) {
	...
	public void populateExpirationDateWithForever(Map<String, Object> map) {
	...
	public void populatePriority(String priority, Map<String, Object> map) {
	...
	public void populateRoleIdFields(
			...
			String viewActionId, Map<String, Object> map)
		throws Exception {
	...
	public void populateUID(
		ClassedModel classedModel, Map<String, Object> map) {
	...
	public void populateUID(
		String modelClassName, long id, Map<String, Object> map) {
	...
	public void populateViewCount(
			Class<?> clazz, long classPK, Map<String, Object> map)
		throws Exception {
	...
	protected void populateRoleIds(
		String field, List<String> values, Map<String, Object> map) {
