...
<%
CustomFacetDisplayContext customFacetDisplayContext = (CustomFacetDisplayContext)Objects.requireNonNull(request.getAttribute(WebKeys.PORTLET_DISPLAY_CONTEXT));
%>
