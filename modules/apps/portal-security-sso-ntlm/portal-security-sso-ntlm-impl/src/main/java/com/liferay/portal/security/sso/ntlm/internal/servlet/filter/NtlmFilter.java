...
public class NtlmFilter extends BaseFilter {
	...
	protected void processFilter(
		...
		// be replied to with an Type 2 NTLM httpServletResponse, no matter whether we're
		...
		if (authorization.startsWith("NTLM")) {
			...
			if (src[8] == 1) {
				...
				// Interrupt filter chain, send httpServletResponse. Browser will
				// immediately post a new httpServletRequest.
