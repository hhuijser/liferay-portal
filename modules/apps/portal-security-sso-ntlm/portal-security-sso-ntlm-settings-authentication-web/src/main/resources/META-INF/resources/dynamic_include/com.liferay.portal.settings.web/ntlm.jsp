...
<aui:fieldset>
	<aui:input
		label="enabled"
		name='<%= PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "enabled" %>'
		type="checkbox"
		value="<%= enabled %>"
	/>
	...
	<aui:input
		...
		name='<%= PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "domainController" %>'
		type="text"
	...
	<aui:input
		cssClass="lfr-input-text-container"
		helpMessage="domain-controller-name-help"
		label="domain-controller-name"
		name='<%= PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "domainControllerName" %>'
		type="text"
	...
	<aui:input
		cssClass="lfr-input-text-container"
		label="domain"
		name='<%= PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "domain" %>'
		type="text"
		value="<%= domain %>"
	/>
	...
	<aui:input
		...
		name='<%= PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "serviceAccount" %>'
		type="text"
	...
	<aui:input
		...
		name='<%= PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "servicePassword" %>'
		type="password"
	...
	<aui:input
		cssClass="lfr-input-text-container"
		label="negotiate-flags"
		name='<%= PortalSettingsNtlmConstants.FORM_PARAMETER_NAMESPACE + "negotiateFlags" %>'
		type="text"
		value="<%= negotiateFlags %>"
	/>
</aui:fieldset>