...
import com.liferay.portal.settings.web.internal.upgrade.v1_0_0.PortletIdUpgradeProcess;
import com.liferay.portal.settings.web.internal.upgrade.v1_0_1.InstanceSettingsPortletIdUpgradeProcess;
...
public class PortalSettingWebUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"1.0.0", "1.0.1", new InstanceSettingsPortletIdUpgradeProcess());
