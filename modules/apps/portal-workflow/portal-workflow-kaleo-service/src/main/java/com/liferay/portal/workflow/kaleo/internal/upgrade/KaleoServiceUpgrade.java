...
public class KaleoServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register("1.0.0", "1.1.0", new WorkflowContextUpgradeProcess());
		...
		registry.register(
			"1.2.1", "1.3.0", new UpgradeClassNames(), new KaleoActionUpgradeProcess(),
		...
		registry.register(
			"1.3.1", "1.3.2", new KaleoClassNameAndKaleoClassPKUpgradeProcess());
