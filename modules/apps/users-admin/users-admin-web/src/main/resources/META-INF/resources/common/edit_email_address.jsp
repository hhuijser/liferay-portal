...
>
	<aui:input
		name="errorMVCPath"
		type="hidden"
		value="/common/edit_email_address.jsp"
	/>
	...
	<aui:input
		name="listType"
		type="hidden"
		value="<%= ListTypeConstants.EMAIL_ADDRESS %>"
	/>
	...
	<div class="container-fluid container-fluid-max-xl">
		...
		<div class="sheet sheet-lg">
			...
			<div class="sheet-section">
				...
				<aui:input
					checked="<%= (emailAddress != null)? emailAddress.isPrimary() : false %>"
					id="emailAddressPrimary"
					label="make-primary"
				...
				<aui:select
					inlineField="<%= true %>"
					label="type"
					listType="<%= editContactInformationDisplayContext.getClassName() + ListTypeConstants.EMAIL_ADDRESS %>"
				...
				<aui:input
					fieldParam="emailAddressAddress"
					id="emailAddressAddress"
					name="address"
					required="<%= true %>"
				/>
			</div>
