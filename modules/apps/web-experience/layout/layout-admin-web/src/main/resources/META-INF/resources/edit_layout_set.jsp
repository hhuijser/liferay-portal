...
String backURL = (PortalUtil.getControlPanelPortletURL(request, null,LayoutSetPrototypePortletKeys.LAYOUT_SET_PROTOTYPE,0, 0, PortletRequest.RENDER_PHASE)).toString();
