		...
		<div class="main-content-card panel">
			<div class="panel-body">
				...
				<div class="btn-toolbar">
					...
					<aui:button
						onClick="<%= taglibEditPage %>"
						primary="<%= true %>"
						value='<%= LanguageUtil.format(request, "create-page-x", HtmlUtil.escapeAttribute(title), false) %>'
					/>
					...
					<aui:button
						...
						value='<%= LanguageUtil.format(request, "search-for-x", HtmlUtil.escapeAttribute(title), false) %>'
					/>
				</div>
			</div>
		</div>
