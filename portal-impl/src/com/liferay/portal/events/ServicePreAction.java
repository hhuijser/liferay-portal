...
public class ServicePreAction extends Action {
	...
	/**
	 * Returns <code>true</code> if the httpServletRequest URI's path starts with the
	 * portal's default login path <code>c/portal/login</code>.
	 *
	 * @param  httpServletRequest the servlet httpServletRequest for the page, which can be a result
	 *         of a redirect
	 * @return <code>true</code> if the httpServletRequest is a login httpServletRequest;
