...
public class WorkflowInstanceLinkModelImpl extends BaseModelImpl<WorkflowInstanceLink>
	...
	public static final String TABLE_SQL_CREATE = "create table WorkflowInstanceLink (workflowInstanceLinkId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(255) null,createDate DATE null,modifiedDate DATE null,classNameId LONG,classPK LONG,workflowInstanceId LONG)";
	...
	public WorkflowInstanceLink toEscapedModel() {
		if (isEscapedModel()) {
			...
			if (_escapedModelProxy == null) {
				_escapedModelProxy = (WorkflowInstanceLink)Proxy.newProxyInstance(_classLoader,
