...
public class CacheFilter extends BasePortalFilter {
	...
	protected void processFilter(
		...
		if ((cacheResponseData == null) || !cacheResponseData.isValid()) {
			...
			// Cache the result if and only if there is a result and the httpServletRequest
			// is cacheable. We have to test the cacheability of a httpServletRequest twice
