...
public class GZipResponse extends HttpServletResponseWrapper {
	...
	public GZipResponse(HttpServletResponse httpServletResponse) {
		...
		// Clear previous content length setting. GZip httpServletResponse does not buffer
		// output to get final content length. The httpServletResponse will be chunked
