...
public class Table {
	...
	public static final String[][] SAFE_CHARS = {
		{StringPool.RETURN, StringPool.COMMA, StringPool.NEW_LINE},
		{
			...
			Table.SAFE_UPGRADE_NEWLINE_CHARACTER
		}
	};

	public static final String SAFE_COMMA_CHARACTER = "_SAFE_COMMA_CHARACTER_";

	public static final String SAFE_UPGRADE_NEWLINE_CHARACTER =
		"_SAFE_UPGRADE_NEWLINE_CHARACTER_";
			...
			try {
				...
				if (clob == null) {
					...
					while ((line = unsyncBufferedReader.readLine()) != null) {
						if (sb.length() != 0) {
							sb.append(SAFE_UPGRADE_NEWLINE_CHARACTER);
						}
