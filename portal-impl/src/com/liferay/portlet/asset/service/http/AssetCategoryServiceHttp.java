...
public class AssetCategoryServiceHttp {
	...
	public static com.liferay.portal.kernel.json.JSONArray getJSONSearch(
		...
		try {
			MethodKey methodKey = new MethodKey(AssetCategoryServiceUtil.class,
					"getJSONSearch", _getJSONSearchParameterTypes8);
	...
	public static com.liferay.portlet.asset.model.AssetsPage<com.liferay.portlet.asset.model.AssetCategory> getVocabularyCategoriesPage(
		HttpPrincipal httpPrincipal, long vocabularyId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator obc)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		try {
			MethodKey methodKey = new MethodKey(AssetCategoryServiceUtil.class,
					"getVocabularyCategoriesPage",
					_getVocabularyCategoriesPageParameterTypes16);
			...
			return (com.liferay.portlet.asset.model.AssetsPage<com.liferay.portlet.asset.model.AssetCategory>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	public static com.liferay.portlet.asset.model.AssetsPage<com.liferay.portlet.asset.model.AssetCategory> getVocabularyCategoriesPage(
		...
		try {
			MethodKey methodKey = new MethodKey(AssetCategoryServiceUtil.class,
					"getVocabularyCategoriesPage",
					_getVocabularyCategoriesPageParameterTypes17);
	...
	public static java.util.List<com.liferay.portlet.asset.model.AssetCategory> getVocabularyRootCategories(
		...
		try {
			MethodKey methodKey = new MethodKey(AssetCategoryServiceUtil.class,
					...
					_getVocabularyRootCategoriesParameterTypes18);
	...
	public static com.liferay.portlet.asset.model.AssetCategory updateCategory(
		...
		try {
			MethodKey methodKey = new MethodKey(AssetCategoryServiceUtil.class,
					"updateCategory", _updateCategoryParameterTypes23);
	...
	private static final Class<?>[] _getJSONSearchParameterTypes8 = new Class[] {
			long.class, java.lang.String.class, long[].class, int.class,
			int.class
		};
	private static final Class<?>[] _getJSONVocabularyCategoriesParameterTypes9 = new Class[] {
			long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	...
	private static final Class<?>[] _getVocabularyCategoriesCountParameterTypes14 =
	...
	private static final Class<?>[] _getVocabularyCategoriesPageParameterTypes16 =
		new Class[] {
			long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getVocabularyCategoriesPageParameterTypes17 =
		new Class[] {
			long.class, java.lang.String.class, long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getVocabularyRootCategoriesParameterTypes18 =
		new Class[] {
			long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	...
	private static final Class<?>[] _updateCategoryParameterTypes23 = new Class[] {
