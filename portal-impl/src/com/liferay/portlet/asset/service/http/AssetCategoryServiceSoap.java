...
public class AssetCategoryServiceSoap {
	...
	*/
	...
	public static com.liferay.portlet.asset.model.AssetsPage<com.liferay.portlet.asset.model.AssetCategory> getVocabularyCategoriesPage(
		...
		throws RemoteException {
		try {
			com.liferay.portlet.asset.model.AssetsPage<com.liferay.portlet.asset.model.AssetCategory> returnValue =
				AssetCategoryServiceUtil.getVocabularyCategoriesPage(vocabularyId,
					start, end, obc);
	...
	public static com.liferay.portlet.asset.model.AssetsPage<com.liferay.portlet.asset.model.AssetCategory> getVocabularyCategoriesPage(
		...
		try {
			com.liferay.portlet.asset.model.AssetsPage<com.liferay.portlet.asset.model.AssetCategory> returnValue =
				AssetCategoryServiceUtil.getVocabularyCategoriesPage(groupId,
					name, vocabularyId, start, end, obc);
