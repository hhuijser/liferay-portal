...
public class AssetTagServiceHttp {
	...
	public static com.liferay.portlet.asset.model.AssetsPage<com.liferay.portlet.asset.model.AssetTag> getGroupTagsPage(
		...
		try {
			MethodKey methodKey = new MethodKey(AssetTagServiceUtil.class,
					"getGroupTagsPage", _getGroupTagsPageParameterTypes7);
			...
			return (com.liferay.portlet.asset.model.AssetsPage<com.liferay.portlet.asset.model.AssetTag>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	private static final Class<?>[] _getGroupTagsPageParameterTypes7 = new Class[] {
