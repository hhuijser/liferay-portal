...
public class AssetTagServiceSoap {
	...
	public static com.liferay.portlet.asset.model.AssetsPage<com.liferay.portlet.asset.model.AssetTag> getGroupTagsPage(
		...
		throws RemoteException {
		try {
			com.liferay.portlet.asset.model.AssetsPage<com.liferay.portlet.asset.model.AssetTag> returnValue =
				AssetTagServiceUtil.getGroupTagsPage(groupId, name, start, end);
