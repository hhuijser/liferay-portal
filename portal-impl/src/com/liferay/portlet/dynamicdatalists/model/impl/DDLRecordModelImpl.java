...
public class DDLRecordModelImpl extends BaseModelImpl<DDLRecord>
	...
	public static final String TABLE_SQL_CREATE = "create table DDLRecord (uuid_ VARCHAR(75) null,recordId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(255) null,versionUserId LONG,versionUserName VARCHAR(255) null,createDate DATE null,modifiedDate DATE null,DDMStorageId LONG,recordSetId LONG,version VARCHAR(75) null,displayIndex INTEGER)";
	...
	public DDLRecord toEscapedModel() {
		if (isEscapedModel()) {
			...
			if (_escapedModelProxy == null) {
				_escapedModelProxy = (DDLRecord)Proxy.newProxyInstance(_classLoader,
