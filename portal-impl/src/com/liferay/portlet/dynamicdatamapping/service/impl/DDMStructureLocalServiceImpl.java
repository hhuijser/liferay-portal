...
public class DDMStructureLocalServiceImpl
	...
	public List<DDMStructure> getClassStructures(
		...
		return ddmStructurePersistence.filterFindByG_C_C(
			groupIds, companyId, classNameId);
	}
	...
	public List<DDMStructure> getClassStructures(
		...
		return ddmStructurePersistence.filterFindByG_C_C(
			groupIds, companyId, classNameId, start, end);
	}
	...
	public List<DDMStructure> getClassStructures(
		...
		return ddmStructurePersistence.filterFindByG_C_C(
			groupIds, companyId, classNameId, QueryUtil.ALL_POS,
