...
public class JavaImportsFormatterTest {
	...
	public void testIfDuplicateImportsAreRemoved() throws Exception {
		...
		assertFormat("duplicates are removed", original, expected);
	}
	...
	public void testIfNewlineIsAppendedAfterImport() throws Exception {
		...
		assertFormat("single import, newline is appended", original, expected);
	}
	...
	public void testIfNewlineIsAppendedBetweenDifferentPackages()
		...
		assertFormat(
			"different package groups are sorted and separated",
			original, expected);
	}
	...
	public void testMixedIntentsSinglePackage() throws Exception {
		...
		assertFormat(
			...
			"even when everything is in the same package",
			original, expected);
	}
	...
	public void testMultipleStaticImports() throws Exception {
		...
		assertFormat(
			"multiple static imports should be preserved",
			original, expected);
	}

	@Test
	public void testNoImports() throws Exception {
		assertFormat("no imports, nothing happens", "", "");
	}
	...
	public void testSortingOfStaticImports() throws Exception {
		...
		assertFormat(
			...
			"however separate package groups must remain separate",
			original, expected);
	}
	...
	public void testSortingWithInnerClass() throws Exception {
		...
		assertFormat(
			...
			"the inner class must be second in order",
			original, expected);
	}
