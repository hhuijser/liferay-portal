...
/**
 * The table class for the Company.
 *
...
public class CompanyTable extends BaseTable<CompanyTable> {
	...
	public final Column<CompanyTable, Integer> maxUsers = createColumn(
		"maxUsers", Integer.class, Types.INTEGER);
