...
/**
 * The table class for the OrgLabor.
 *
...
public class OrgLaborTable extends BaseTable<OrgLaborTable> {
	...
	public final Column<OrgLaborTable, Long> orgLaborId = createColumn(
		"orgLaborId", Long.class, Types.BIGINT);
