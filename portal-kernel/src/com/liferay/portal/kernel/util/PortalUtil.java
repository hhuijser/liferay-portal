...
public class PortalUtil {
	 ...
	 *        description
	 * @param httpServletRequest the servlet httpServletRequest for the page
	 */
	...
	/**
	 * Appends the subtitle to the current subtitle of the page in the httpServletRequest.
	 *
	...
	/**
	 * Appends the title to the current title of the page in the httpServletRequest.
	 *
	...
	/**
	 * Adds an entry to the portlet breadcrumbs for the page in the httpServletRequest.
	 *
	 * @param httpServletRequest the servlet httpServletRequest for the page
	...
	/**
	 * Generates a random key to identify the httpServletRequest based on the input string.
	 *
	 * @param  httpServletRequest the servlet httpServletRequest for the page
