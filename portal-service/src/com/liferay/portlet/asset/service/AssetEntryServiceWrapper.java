	...
	*/
	public com.liferay.portlet.asset.model.AssetEntry updateEntry(
		...
		return _assetEntryService.updateEntry(groupId, className, classPK,
			classUuid, classTypeId, categoryIds, tagNames, visible, createDate,
			modifiedDate, startDate, endDate, publishDate, expirationDate,
	...
	public com.liferay.portlet.asset.model.AssetEntry updateEntry(
		...
		return _assetEntryService.updateEntry(groupId, className, classPK,
			classUuid, classTypeId, categoryIds, tagNames, visible, createDate,
			modifiedDate, startDate, endDate, expirationDate, mimeType, title,
