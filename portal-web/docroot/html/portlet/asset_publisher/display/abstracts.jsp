...
String summary = StringUtil.shorten(assetRenderer.getSummary(locale, liferayPortletRequest, liferayPortletResponse), assetPublisherDisplayContext.getAbstractLength());
