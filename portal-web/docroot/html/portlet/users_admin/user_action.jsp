...
<liferay-ui:icon-menu>
	...
	<c:if test="<%= permissionChecker.isOmniadmin() || (UserPermissionUtil.contains(permissionChecker, userId, ActionKeys.UPDATE) && (PropsValues.LAYOUT_USER_PRIVATE_LAYOUTS_MODIFIABLE || PropsValues.LAYOUT_USER_PUBLIC_LAYOUTS_MODIFIABLE)) %>">
