...
public class SearchContainerTei extends TagExtraInfo {
	...
	public VariableInfo[] getVariableInfo(TagData tagData) {
		String totalVar = GetterUtil.getString(
			tagData.getAttributeString("totalVar"),
			SearchContainer.DEFAULT_TOTAL_VAR);

		String var = GetterUtil.getString(
			tagData.getAttributeString("var"), SearchContainer.DEFAULT_VAR);
